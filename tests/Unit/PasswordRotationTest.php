...
final class PasswordRotationTest extends EppTestCase
{
    ...
    protected function setUp(): void {
        ...
        Helpers::useEppClientFactory(function (): Client {
            $client = new Client();
    ...
    protected function tearDown(): void {
        Helpers::useEppClientFactory(null);
        parent::tearDown();
    }
    ...
    public function testCandidateIsPromotedWhenTheRegistryAcceptsIt(): void {
        ...
        Helpers::reconcilePendingPassword();
    ...
    public function testCandidateIsKeptWhenNeitherPasswordWorks(): void {
        ...
        $log = Helpers::reconcilePendingPassword();
    ...
    public function testNoCandidateIsANoOp(): void {
        ...
        $this->assertSame([], Helpers::reconcilePendingPassword());
    ...
    public function testTheCandidateIsPersistedBeforeItIsSent(): void {
        ...
        $seenAtLogin = null;
        Helpers::useEppClientFactory(function () use (&$seenAtLogin): Client {
            $client = new Client();
            $transport = new FakeTransport();
            $client->setTransport($transport);
            $transport->queue(CommandCatalog::GREETING_RESPONSE);
        ...
        Helpers::rotateEppPasswordOnReminder();
