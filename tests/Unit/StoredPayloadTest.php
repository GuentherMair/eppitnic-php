...
final class StoredPayloadTest extends TestCase
{
    ...
    /**
     * `sv_httpheaders` was wrapped as an array, not a string: 6.x kept headers
     * as a field => value map where current code stores the raw block, so
     * rejecting them left all 532 such rows in the live database undecodable.
     */
