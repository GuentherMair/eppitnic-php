...
/**
 * A step did not do what it set out to do. Thrown by Run::ensure() so a scenario
 * reads as a sequence rather than a ladder of `if ( ! $ok)`; Run::step() catches
 * it and turns it into a failed Step.
 *
 * @category    Net
