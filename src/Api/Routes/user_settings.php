 ...
 * and change, or an admin's to reach into, same as the rest of this file.
 * Only takes effect while the system-wide `smtp.recipient_mode` includes
 * 'user'; see GET/PATCH /v1/smtp.
 */
...
$app->patch('/v1/users/{id}/notifications', function (Request $request, Response $response, array $args): Response {
    ...
    History::record('users', $userId, 'update', array_intersect_key($params, array_flip(['message_types', 'fulltext'])), $actor['id']);
